...
namespace News.Controllers
{
    public class PartialsController : Help   
    {
        ...
        public ActionResult Footers()
        {
            ...
            var popularNews = db.Query("SELECT TOP 3 n.ID,n.TITLE,Convert(varchar,n.CREATEDATE,103) CREATEDATE,n.AUTHOR,ni.SMALLIMAGE SMALLIMAGE, c.NAME_ CategoryName FROM NEWS n inner join NEWSIMAGES ni on ni.NEWSID = n.ID inner join CATEGORIES c on n.CATEGORYID = c.ID  order by VIEWS_ desc ");
